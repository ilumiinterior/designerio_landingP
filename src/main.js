...
const translations = {
  sk: {
    ...
    'hero.lead': 'Nahrajte fotografiu, uprav. Bez hádania a nečakaných prekvapení.',
    ...
    'demo.lead': 'Stačí označiť objekt, zmeniť cez úpravu a vytvoriť návrh.',
    ...
    'steps.title': 'Tri kroky.<br>Všetkou pod vašou kontrolou',
    'steps.oneTitle': 'Nahrajte fotografiu',
    'steps.oneText': 'Stačí jeden záber miestnosti. Designerio spraví analýzu a ostatné je už na vás',
    'steps.moodCalm': 'minimalistický',
    'steps.moodNatural': 'japandi',
